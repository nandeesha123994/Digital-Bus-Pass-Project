<?php
// This script will help you add the rewards navigation to both dashboards
...
// 3. Instructions for adding to user-dashboard.php
echo "To add rewards navigation to user-dashboard.php:\n";
echo "1. Find the navigation section in user-dashboard.php\n";
echo "2. Add this line after the 'Apply for Pass' link:\n";
echo '<?php include("includes/rewards-nav.php"); ?>' . "\n\n";

// 4. Instructions for adding to admin-dashboard.php
echo "To add rewards navigation to admin-dashboard.php:\n";
echo "1. Find the navigation section in admin-dashboard.php\n";
echo "2. Add this line after the 'Applications' link:\n";
echo '<?php include("includes/rewards-nav.php"); ?>' . "\n\n";

echo "The rewards navigation has been set up! Follow the instructions above to add it to your dashboards.\n";
?> 